...
public class InstructionLoader {
	...
	public static Instruction getLoadedInstruction(String opcode, String[] operands) {
		...
		case CommonConstants.SW: // add logic to handle the case without () i.e
			...
			offset = Integer.parseInt(operands[1].substring(0, operands[1].indexOf('(')));
			reg2 = operands[1].substring(operands[1].indexOf('(') + 1, operands[1].indexOf(')'));
			inst = new SW(reg1, reg2, offset);
			break;
		case CommonConstants.LD:
			reg1 = operands[0];
			offset = Integer.parseInt(operands[1].substring(0, operands[1].indexOf('(')));
			reg2 = operands[1].substring(operands[1].indexOf('(') + 1, operands[1].indexOf(')'));
			inst = new LD(reg1, reg2, offset);
			break;
		case CommonConstants.SD:
			reg1 = operands[0];
			offset = Integer.parseInt(operands[1].substring(0, operands[1].indexOf('(')));
			reg2 = operands[1].substring(operands[1].indexOf('(') + 1, operands[1].indexOf(')'));
			inst = new SD(reg1, reg2, offset);
			break;
		case CommonConstants.DADD:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new DADD(reg1, reg2, reg3);
			break;
		case CommonConstants.DADDI:
			reg1 = operands[0];
			reg2 = operands[1];
			imm = Integer.parseInt(operands[2]);
			inst = new DADDI(reg1, reg2, imm);
			break;
		case CommonConstants.DSUB:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new DSUB(reg1, reg2, reg3);
			break;
		case CommonConstants.DSUBI:
			reg1 = operands[0];
			reg2 = operands[1];
			imm = Integer.parseInt(operands[2]);
			inst = new DSUBI(reg1, reg2, imm);
			break;
		case CommonConstants.AND:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new AND(reg1, reg2, reg3);
			break;
		case CommonConstants.ANDI:
			reg1 = operands[0];
			reg2 = operands[1];
			imm = Integer.parseInt(operands[2]);
			inst = new ANDI(reg1, reg2, imm);
			break;
		case CommonConstants.OR:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new OR(reg1, reg2, reg3);
			break;
		case CommonConstants.ORI:
			reg1 = operands[0];
			reg2 = operands[1];
			imm = Integer.parseInt(operands[2]);
			inst = new ORI(reg1, reg2, imm);
		case CommonConstants.LI:
			reg1 = operands[0];
			imm = Integer.parseInt(operands[1]);
			inst = new LI(reg1, imm);
			break;
		case CommonConstants.LUI:
			reg1 = operands[0];
			imm = Integer.parseInt(operands[1]);
			inst = new LUI(reg1, imm);
			break;
		case CommonConstants.ADDD:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new ADDD(reg1, reg2, reg3);
			break;
		case CommonConstants.MULTD:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new MULTD(reg1, reg2, reg3);
			break;
		case CommonConstants.DIVD:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new DIVD(reg1, reg2, reg3);
			break;
		case CommonConstants.SUBD:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new SUBD(reg1, reg2, reg3);
			break;
		...
		case CommonConstants.BEQ:
			...
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new BEQ(reg1, reg2, reg3);
			break;
		case CommonConstants.BNE:
			reg1 = operands[0];
			reg2 = operands[1];
			reg3 = operands[2];
			inst = new BNE(reg1, reg2, reg3);
			break;
